# crypto_utils.py
# Script de funções de criptografia e segurança para aplicações IoT
...
# =========================
# Funções existentes do crypto_utils.py
# =========================
...
def verify_hmac_old(message: str, signature: bytes, key: str) -> bool:
    """
...
# =========================
# 1. AES-256-CBC + HMAC (Encrypt-then-MAC) - Classe aprimorada
# =========================
...
# =========================
# 3. HMAC-SHA256 (Assinatura de comandos) - Funções aprimoradas
# =========================
...
#     setup_logging(level=logging.DEBUG, log_file="crypto_utils.log")
